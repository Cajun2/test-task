package com.test.task.ticket.controllers.exception;


import com.test.task.ticket.exceptions.ErrorDetails;
import com.test.task.ticket.exceptions.GenericException;
import com.test.task.ticket.access.domain.enumes.GenericStatus;
